...
export function filterByVaccination(payload){
  return async function (dispatch) {
    let json = await axios.get(`http://localhost:3001//filterByVaccination`);
      return dispatch({
...
export function filterByType(payload){
  return async function (dispatch) {
    let json = await axios.get(`http://localhost:3001/filterByType`);
      return dispatch({
...
export function filterBySize(payload){
  return async function (dispatch) {
    let json = await axios.get(`http://localhost:3001/filterBySize`);
      return dispatch({
...
export function filterByCastrated(payload){
  return async function (dispatch) {
    let json = await axios.get(`http://localhost:3001/filterByCastrated`);
      return dispatch({
...
export function filterByPlace(payload){
  return async function (dispatch) {
    let json = await axios.get(`http://localhost:3001/filterByPlace`);
      return dispatch({
...
export function filterByAge(payload){
  return async function (dispatch) {
    let json = await axios.get(`http://localhost:3001/filterByAge`);
      return dispatch({
