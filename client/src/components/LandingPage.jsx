        ...
        <div className="flex flex-col-6 m-5 mx-9 mt-8 items-center">
            ...
            <div className="flex flex-col w-full max-w-md m-14 mr-24 py-8 bg-amber-600 rounded-lg shadow sm:px-6 md:px-8 lg:px-10">
                ...
                <div className="flex items-center justify-center mt-6">
                    <Link to='/register' style={{ textDecoration: 'none' }} className="inline-flex items-center text-s font-thin text-center text-gray-500 hover:text-gray-700 dark:text-gray-100 dark:hover:text-yellow-900">
                        <span class="ml-2">
