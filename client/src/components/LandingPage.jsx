                        ...
                        <form autoComplete="off" onSubmit={handleSubmit}>
                            <div className="flex flex-col mb-2">
                                <div className="flex relative">
                                    ...
                                    <input type="text" name="email" value={input.email} onChange={(e) => handleChange(e)} id="sign-in-email" className=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-yellow-800 focus:border-transparent" placeholder="Complete su email" />
                            ...
                            <div className="flex flex-col mb-6">
                                <div className="flex relative ">
                                    ...
                                    <input type="password" id="sign-in-email" name="password" value={input.password} onChange={(e) => handleChange(e)} className=" rounded-r-lg flex-1 appearance-none border border-gray-300 w-full py-2 px-4 bg-white text-gray-700 placeholder-gray-400 shadow-sm text-base focus:outline-none focus:ring-2 focus:ring-yellow-800 focus:border-transparent" placeholder="Complete su contraseña" />
...
//                     <br />
//                     <p className="self-center mb-6 text-xl font-light italic tracking-wide text-gray-600 sm:text-2xl">Somos una organización sin fines de lucro con el objetivo de encontrar un hogar feliz para nuestros amigos de 4 patas...</p>
