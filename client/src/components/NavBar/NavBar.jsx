  ...
  return (
    <section className="flex justify-center h-14">
      <div className="bg-orange-300 flex justify-between border-b-4 border-white w-screen justify-center content-around items-center px-4">
        <div className="flex">
          <h1 className="text-white text-2xl font-sans">Happy Tails</h1>
        </div>
        <div className="flex w-80 justify-around">
          <Link to={"/home"}>
            <h2 className="text-black text-2xl font-sans">Home</h2>
          </Link>
          <Link to={"/algo"}>
            <h2 className="text-black text-2xl font-sans">Algo</h2>
          </Link>
          <Link to={"/about"}>
            <h2 className="text-black text-2xl font-sans">About</h2>
          </Link>
        </div>
        <div className="flex">
          <form>
        ...
        <div className="flex gap-3 items-center">
          <p className="text-white">Lautaro Martín</p>
