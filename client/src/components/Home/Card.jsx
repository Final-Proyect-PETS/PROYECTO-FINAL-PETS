...
export default function Card({ idUser, first_name, last_name, imageUser, idPet, namePet, imagePet, place, size }) {
      ...
      >
        ...
        <Link to={"/pet/" + idPet}>
          <div className="py-3 flex">
            <img className="w-96 bg-cover rounded" src={imagePet} alt="imagepet" />
